...
// un cliente global 'mercadopago' ha sido eliminado.
// El nuevo sistema (MP Connect) crea clientes por transacción
// usando el token del dueño en los servicios (ej: alquiler.service.ts).
// --- FIN DEL CAMBIO ---

...
import corsValidation from './middlewares/cors.middleware';
...
import debugging from './middlewares/debugging.middleware';
...
app.use(corsValidation(allowedOrigins));
...
//         return res.json({ success: true, message: 'Tablas creadas exitosamente' });
...
//     return res.json({ message: "Seed endpoint is working!" });
// });
